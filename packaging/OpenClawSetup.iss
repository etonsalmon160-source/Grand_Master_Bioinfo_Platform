...
Source: "..\bioinfo_app.py"; DestDir: "{app}"; Flags: ignoreversion; Check: NeedAppScripts
...
Source: "..\openclaw_config.json"; DestDir: "{app}"; Flags: ignoreversion; Check: NeedAppScripts
...
begin
  Result := not FileExists(ExpandConstant('{app}\bioinfo_app.py'));
end;
